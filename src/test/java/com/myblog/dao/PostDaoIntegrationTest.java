...
class PostDaoIntegrationTest {
    ...
    void testDecrementLikesNotBelowZero() {
        ...
        postDao.decrementLikes(created.getId());

        Optional<Post> updated = postDao.findById(created.getId());
        assertTrue(updated.isPresent());
        assertEquals(0, updated.get().getLikesCount());
    }

    @Test
    void testIncrementLikesNotFoundThrows() {
        assertThrows(IllegalArgumentException.class, () -> postDao.incrementLikes(999999L));
    }

    @Test
    void testDecrementLikesNotFoundThrows() {
        assertThrows(IllegalArgumentException.class, () -> postDao.decrementLikes(999999L));
    }
}
